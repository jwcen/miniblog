...
var file_apiserver_v1_user_proto_rawDesc = []byte{
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x42, 0x33, 0x5a, 0x31, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x77, 0x63, 0x65, 0x6e, 0x2f,
	0x6d, 0x69, 0x6e, 0x69, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
func file_apiserver_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_apiserver_v1_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_apiserver_v1_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_apiserver_v1_user_proto_msgTypes[16].Exporter = func(v any, i int) any {
